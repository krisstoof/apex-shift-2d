...
func bind(p_player: Node, p_evolution_director: Node, p_day_night_system: Node, p_ecosystem_director: Node = null) -> void:
	...
	var biome_zones := _to_dictionary_array(world_snapshot.get("biome_zones", WORLD_CONFIG.get_biome_zones()))
	var landmarks := _to_dictionary_array(world_snapshot.get("landmarks", WORLD_CONFIG.get_landmarks()))
