...
func get_debug_status() -> Dictionary:
	return {
		"world": get_world() != null,
		"player": get_player() != null,
		"day_night_system": get_day_night_system() != null,
		"ecosystem_director": get_ecosystem_director() != null,
		"evolution_director": get_evolution_director() != null,
		"save_system": get_save_system() != null,
		"event_bus": get_event_bus() != null,
		"game_session": get_game_session() != null,
		"ui_root": get_ui_root() != null,
		"snapshot_service": get_snapshot_service() != null
	}
