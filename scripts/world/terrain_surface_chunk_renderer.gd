...
func _apply_local_transition(color: Color, biome_id: String, terrain_id: String, world_pos: Vector2) -> Color:
	...
	for pos in neighbor_positions:
		var neighbor_terrain := _get_surface_terrain(pos)
		var neighbor_biome := _get_visual_biome(pos)
...
func _draw_chunk_placeholder(chunk_key: Vector2i) -> void:
	draw_rect(_get_chunk_world_rect(chunk_key), Color(0.08, 0.18, 0.11), true)
