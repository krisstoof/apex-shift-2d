...
const BIOME_TEXTURES := {
	...
	"terrain_surface_preview_texture_size": 48,
	"terrain_surface_preview_max_chunks_built_per_frame": 4,
	...
	"terrain_surface_max_build_ms_per_frame": 4.0,
	"terrain_surface_refined_texture_size": 96,
	"terrain_surface_refine_max_rows_built_per_frame": 8,
	"terrain_surface_refine_max_build_ms_per_frame": 4.0,
	"terrain_surface_refine_delay_seconds": 0.15,
	...
	"terrain_surface_draw_placeholders": false,
	"terrain_surface_placeholder_alpha": 0.0,
	"terrain_surface_ocean_background_enabled": true,
	"legacy_biome_detail_overlay_enabled_with_surface_renderer": false,
	"terrain_surface_sample_cache_enabled": false,
	"terrain_surface_sample_cache_step": 8.0,
	"terrain_surface_use_exact_shape_sampling": true,
	"terrain_surface_edge_supersampling_enabled": true,
