...
const RUNTIME_CONTEXT_SMOKE_TESTS := preload("res://tests/unit/test_runtime_context_smoke.gd")
const RUNTIME_CONTEXT_LEGACY_PATH_SCAN_TESTS := preload("res://tests/unit/test_runtime_context_legacy_path_scan.gd")
const RUNTIME_LOOKUP_SCAN_TESTS := preload("res://tests/unit/test_runtime_lookup_scan.gd")
...
func _run_tests() -> void:
	...
	await _run_suite("RuntimeLookupScan", RUNTIME_LOOKUP_SCAN_TESTS.new(), failures)
